...
* **Getting context:**
	* Click [here](https://github.com/code-differently/StayReadyLab03/blob/master/README-TDDPatterns.md) to gain more familiarity with TDD-structured programming.
